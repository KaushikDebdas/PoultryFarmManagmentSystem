...
?>
                <tbody>
                    <tr>
                        <td><?php echo $id ?></td>
                        <td><img width="50px" src="img/profile/<?php echo $pic ?>"></td>
                        <td><?php echo $username ?></td>
                        <td><?php echo $useremail ?></td>
                        <td><?php echo $phone ?></td>
                        <td><?php echo $password ?></td>
                        <td><a href="update.php?edit_id=<?php echo $id ?>">Update</a> || <a onclick="return confirm('Are you sure?')" href="delete.php?user_id=<?php echo $id ?> & $profile_pic=<?php echo $pic ?> ">Delete</a></td>
                    </tr>
                </tbody>
